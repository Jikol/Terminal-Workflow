...
oh-my-posh init pwsh --config $env:USERPROFILE\.config\prompt\fluent.json | Invoke-Expression
...
Set-Variable "CONFIG_PROMPT" "$env:USERPROFILE\.config\prompt\fluent.json"
Set-Variable "CONFIG_PROFILE" "$env:USERPROFILE\.config\powershell\user_profile.ps1"
